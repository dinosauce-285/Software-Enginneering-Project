...
export default function NavigationBar() {
    return (
        <aside className="flex flex-col bg-white border-r shadow w-[9rem] min-h-screen fixed left-0 top-0 overflow-hidden">
            ...
            {/* Icons container*/}
            <div className="flex flex-col items-center flex-grow mt-[120%] space-y-[30%] overflow-hidden">
                <svg className="w-9 h-9 text-gray-500 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
