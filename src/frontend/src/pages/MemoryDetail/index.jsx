...
//                 <span>{date}</span><span className="text-gray-400">•</span><span>{time}</span>
//               </div>
...
//                 <HashtagIcon className="w-6 h-6 text-gray-600" />
//                 <span className="text-blue-600">{tagsString}</span>
//               </div>}
//             </div>
//             <div className="flex items-center gap-2 flex-shrink-0">
//               <RouterLink to="/dashboard" className="p-2 rounded-full hover:bg-gray-200 transition-colors">
...
export default function MemoryDetail() {
  ...
  if (error || !memory) {
    // Đã thêm style dark mode cho trang lỗi
    return (
      <AppLayout>
